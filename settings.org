...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24702 34310 374769 344000) :init (24702 34310 374749 494000) :init-secs (0 0 54 817000) :use-package-secs (0 0 238 620000) :config (24702 34310 374725 840000) :config-secs (0 0 12 857000)))
...
# Закомментил т.к. пока не научился этим пользоваться
# #+BEGIN_SRC emacs-lisp
# (use-package paredit
