...
(use-package lsp-mode
  ...
  :hook ((lsp-after-initialize
         . (lambda ()
             ...
             (flycheck-add-next-checker 'lsp 'go-vet t)))
...
(use-package conventional-changelog
  :quelpa (conventional-changelog
           :fetcher github
           :repo "johnlepikhin/el-conventional-changelog"))
#+END_SRC
...
*** Подсветка TODO/FIXME
 ...
 (use-package fic-mode
   :hook cperl-mode emacs-lisp-mode rust-mode rustic-mode rjsx-mode lsp-mode go-mode)
 #+END_SRC
